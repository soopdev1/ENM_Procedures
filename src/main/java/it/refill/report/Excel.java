...
import static it.refill.exe.Constant.cf_soggetto_DD;
import static it.refill.exe.Constant.codice_bb;
import static it.refill.exe.Constant.codice_yisu_neet;
import static it.refill.exe.Constant.codice_yisu_ded;
import static it.refill.exe.Constant.coeff_ddr_dd;
...
import static it.refill.exe.Constant.contoallievifaseA_DD;
import static it.refill.exe.Constant.contoallievifaseB;
import static it.refill.exe.Constant.contoallievifaseB_DD;
import static it.refill.exe.Constant.contodocentiA;
import static it.refill.exe.Constant.contodocentiA_DD;
import static it.refill.exe.Constant.contodocentiB;
import static it.refill.exe.Constant.contodocentiB_DD;
import static it.refill.exe.Constant.getCell;
import static it.refill.exe.Constant.getRow;
import static it.refill.exe.Constant.percentuale_attribuzioneDD;
import static it.refill.exe.Constant.setCell;
import static it.refill.exe.Constant.tipologia_costo;
import static it.refill.exe.Constant.tipologia_giustificativo;
...
public class Excel {
    ...
    private static final Long hh36 = new Long(129600000);
