...
import static it.refill.exe.Constant.codice_bb;
import static it.refill.exe.Constant.codice_yisu;
import static it.refill.exe.Constant.coeff_docfasciaA;
import static it.refill.exe.Constant.coeff_docfasciaB;
import static it.refill.exe.Constant.coeff_faseA;
import static it.refill.exe.Constant.coeff_faseB;
import static it.refill.exe.Constant.contoallievifaseA;
import static it.refill.exe.Constant.contoallievifaseB;
import static it.refill.exe.Constant.contodocentiA;
import static it.refill.exe.Constant.contodocentiB;
...
import static it.refill.exe.Constant.zipListFiles;
...
public class Excel {
    ...
    public static final SimpleDateFormat sdfITA = new SimpleDateFormat("dd/MM/yyyy");
...
//    }
    ...
    public static File prospetto_riepilogo(int idestrazione, List<Integer> list_idpr, Db_Bando db1) {
            ...
            try (Connection conn = db1.getConnection()) {
                if (conn != null) {
                    ...
                    try (XSSFWorkbook wb = new XSSFWorkbook(new FileInputStream(new File(fileing)))) {
                        ...
                        byte[] bianco = {(byte) 255, (byte) 255, (byte) 255};
                        byte[] color1 = {(byte) 49, (byte) 134, (byte) 155};
                        byte[] color2 = {(byte) 83, (byte) 141, (byte) 213};
                        byte[] color3 = {(byte) 197, (byte) 217, (byte) 241};
                        byte[] color4 = {(byte) 238, (byte) 30, (byte) 30};
                        byte[] color5 = {(byte) 0, (byte) 204, (byte) 0};

                        XSSFColor myColor1 = new XSSFColor(color1, new DefaultIndexedColorMap());
                        XSSFColor myColor2 = new XSSFColor(color2, new DefaultIndexedColorMap());
                        XSSFColor myColor3 = new XSSFColor(color3, new DefaultIndexedColorMap());
                        XSSFColor myColor4 = new XSSFColor(color4, new DefaultIndexedColorMap());
                        XSSFColor myColor5 = new XSSFColor(color5, new DefaultIndexedColorMap());
                        XSSFColor white = new XSSFColor(bianco, new DefaultIndexedColorMap());
...
//                                                                    tot_B.addAndGet(presenza.get(cal1.getData()));
                                                        ...
                                                        if (tot_ore_docenti_FA.get() > 0) {
                                                            ...
                                                            sd01_W.write(indice_dainserire + separator + codicefiscale + separator
                                                                    + codice_yisu + separator + contodocentiA + separator + getDoubleforTXT(tot_ore_docenti_FA.get()) + separator
                                                        ...
                                                        sd01_W.write(indice_dainserire1 + separator + codicefiscale + separator
                                                                + codice_yisu + separator + contoallievifaseA + separator + getDoubleforTXT(tot_A) + separator
                                                        ...
                                                        sd01_W.write(indice_dainserire2 + separator + codicefiscale + separator
                                                                + codice_yisu + separator + contoallievifaseB + separator + getDoubleforTXT(tot_B) + separator
...
//                                index_allievo.addAndGet(4);
    ...
    public static List<Items> calendario(int idpr, Connection conn) {
    ...
    public static Map<Long, Long> OreRendicontabiliAlunni_faseA(Connection conn, int pf) {
    ...
    public static Map<Long, Long> OreRendicontabiliAlunni_faseB(Connection conn, int pf) {
        Map result = new HashMap();
        try {
    ...
    public static Map<Long, Long> OreRendicontabiliDocentiFASEA(Connection conn, int pf) {
        Map result = new HashMap();
        try {
    ...
    public static double roundFloatAndFormat(float f) {
        try {
