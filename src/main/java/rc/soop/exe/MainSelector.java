    ...
    public static void main(String[] args) {
        ...
        switch (select_action) {
            ...
            case 3 -> {
                ...
                try {
                    tg.report_docenti(true);
                } catch (Exception e) {
                }
                try {
                    tg.report_docenti_GG1(true);
                } catch (Exception e) {
                }
                try {
                    tg.report_allievi(true);
                } catch (Exception e) {
                }
                try {
                    tg.report_pf(true);
            ...
            case 4 -> {
                ...
                crearegistri(testing,false);
                log.warning("GESTIONE TOSCANA - UPDATE ORE CONVALIDATE");
                tg.ore_convalidateAllievi(null);
                tg.ore_ud(null);
                break;
            }
            case 5 -> {
            ...
            case 11 -> { //AGGIORNA TUTTI I REGISTRI
                try {
                    crearegistri(testing,true);
                } catch (Exception e) {
                    log.severe(estraiEccezione(e));
                }
            }
            case 12 -> { //AGGIORNA ORE
                try {
                    tg.ore_convalidateAllievi(null);
                    tg.ore_ud(null);
                } catch (Exception e) {
